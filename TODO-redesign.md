...
- [x] AI-стендап за минуту: собирает апдейты команды и формирует отчёт
- [x] Сверка ожиданий: сравнивает план vs факт, объясняет отклонения
- [x] Менеджерский Автопилот: напоминания, пинги и эскалации просрочек
- [x] Сценарный симулятор: "если сделаем X" → эффект на KPI
- [x] Умный протокол встреч: извлекает решения, владельцев, сроки
- [x] Рост и развитие в один клик: персональные планы развития по ролям
- [x] Бюджет по задачам: оценка затрат + предупреждения о перерасходе
