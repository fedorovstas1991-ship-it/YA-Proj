...
- [ ] Пересмотреть все `btn` классы на предмет соответствия новому дизайну.
- [ ] Убедиться, что новые цветовые переменные применяются корректно ко всем компонентам.
- [ ] При необходимости, добавить новые классы или изменить inline стили для соответствия отступам, теням, радиусам.
