...
export function renderChannels(props: ChannelsProps) {
  ...
  const telegramAccounts = props.snapshot?.channelAccounts?.telegram ?? [];
  const accountCountLabel = renderChannelAccountCount("telegram", props.snapshot?.channelAccounts ?? {});
